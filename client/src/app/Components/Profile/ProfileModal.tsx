        ...
        <div className="mt-4 relative flex justify-between">
          <div className="relative inline-block">
            ...
            <div className="absolute bottom-0 right-1 shadow-sm">
              ...
              <span className="absolute z-20 left-[50%] top-[50%] transalate-x-[-50%] transalte-y-[-50%] text-xs text-white">
                {check}
              </span>
            </div>
          </div>
        ...
        >
          <div className="pt-2 grid grid-cols-[150px_1fr]">
            ...
            <input
              ...
              className="py-[0.4rem] px-3 font-medium rounded-lg border-2 border-[@3232320/10]"
            />
          </div>
